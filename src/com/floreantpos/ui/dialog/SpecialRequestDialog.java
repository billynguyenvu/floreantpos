...
public class SpecialRequestDialog extends OkCancelOptionDialog {
	private JTextField tfNumber;
	private String value;
	private QwertyKeyPad qwertyKeyPad;

	public SpecialRequestDialog() {
		super(POSUtil.getFocusedWindow(), "Special request");
		init();
	}

	public SpecialRequestDialog(Frame parent) {
		super(parent, "Special request");
		init();
	}
