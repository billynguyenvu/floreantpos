...
public class DebitCardReportModel extends ListTableModel<DebitCardTransaction> {

	final String DATE_FORMAT = "dd-MM-yyyy";

	public DebitCardReportModel(List<DebitCardTransaction> datas) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		DebitCardTransaction transaction = getRowData(rowIndex);
