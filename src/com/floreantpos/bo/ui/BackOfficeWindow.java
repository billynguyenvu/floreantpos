...
import com.floreantpos.bo.actions.DebitCardReportAction;
...
import com.floreantpos.bo.actions.MenuAddonExplorerAction;
...
public class BackOfficeWindow extends javax.swing.JFrame {
	...
	private void createReportMenu(JMenuBar menuBar) {
		...
		reportMenu.add(new CashReportAction());
		reportMenu.add(new CreditCardReportAction());
		reportMenu.add(new DebitCardReportAction());
