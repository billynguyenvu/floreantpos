...
public class POSConstants {
	...
	public static final String TICKET_LIST_COLUMN_PAYMENT_TYPE = "PAYMENT TYPE"; //$NON-NLS-1$
	...
	public static final String DEBIT_CARD_REPORT = Messages.getString("PosMessage.228"); //$NON-NLS-1$
	public static final String CASH_REPORT = "Cash Report"; //$NON-NLS-1$
