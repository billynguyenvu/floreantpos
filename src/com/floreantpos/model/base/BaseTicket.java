...
public abstract class BaseTicket  implements Comparable, Serializable {
	...
	/**
	 * Return the value associated with the column: PRINTED_CUSTOMER_COPY
	 */
	public Boolean getPrintedCustomerCopy () {
					return printedCustomerCopy;
			}

	/**
	 * Set the value related to the column: PRINTED_CUSTOMER_COPY
	 * @param printedCustomerCopy the PRINTED_CUSTOMER_COPY value
	 */
